...
function checkoutMessage(r: ReservationForSms): string {
  return [
    "[타입라운지] 안녕하세요, 이용해주셔서 감사합니다 :)",
    "",
    r.deposit_required
      ? "정상 퇴실 확인되었습니다! 청소 보증금은 24시간 내로 입금하신 계좌로 환불해 드릴게요."
      : "정상 퇴실 확인되었습니다!",
    "",
    "혹시 이용하시고 사진 한 장 남기고 리뷰까지 써주시면, 다음에 예약하실 때 이용 시간을 더 챙겨드릴게요!",
    "",
    "다음에 또 편하게 찾아주세요. 좋은 하루 보내세요!",
  ].join("\n");
}

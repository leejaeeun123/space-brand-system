...
- 비주얼: **MCM 그래픽**(바우하우스·기하, 볼드 웜 컬러) + 레이어 분리(디지털 컬러풀 / 공간 물성)
- 네이밍(1순위 가정): **선룸 (SUN ROOM)** — 따뜻한 거실·태양 모티프(팔레트 직결) / 최종 확정·상표 확인 대기
...
1. **네이밍 확정** — 선룸 / 오빗 / 모드룸 (또는 노모룸) 중 선택 + 상표·도메인 라이브 확인 (`02-naming/validation.md`)

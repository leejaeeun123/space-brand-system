...
> 역할: `spine/white`·`spine/ink` = **메인**, `spine/orange` = **엑센트**. 셋이 브랜드 식별 3색.

| 토큰 | HEX | RGB | CMYK (근사) | Pantone (근사) | 소재(물리) |
|---|---|---|---|---|---|
| `color/spine/orange` | #E2531E | 226,83,30 | 3·80·95·0 | 1655 C | 컬러 도장(스틸/아크릴) |
| `color/spine/white` | #ffffff | 255,255,255 | 0·0·0·0 | — (흰색 종이) | 화이트 도장/아크릴·흰색 종이 |
...
- **공간 사이니지(물리)**: CMYK/Pantone·소재 토큰, 블랙·화이트 물성 중심(차분).

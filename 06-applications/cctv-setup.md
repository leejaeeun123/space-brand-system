...
- [ ] **촬영범위 최소화** — 화장실은 절대 불가. 라운지 전체를 훑기보다 **출입구 방향**이
      목적(범죄예방·시설안전)에도 맞고 손님 저항도 적다.
...
- [ ] Tapo 상시전원 실내 모델. 비 안 맞는 곳에만 다니 방수는 필요 없다.
- [ ] **SD카드를 같이 산다.** 아래를 보면 선택이 아니다.
- [ ] 출입구가 보이는 위치. 콘센트가 닿는지 먼저 본다.
...
| 소스 | 하루/대 | 7일 | 30일 |
|---|---|---|---|
| `stream1` 고화질 | 20~40GB | 140~280GB | 600GB~1.2TB |
| `stream2` 저화질 | 3~5GB | 21~35GB | 90~150GB |
